...
class Question(models.Model):
    ...
    job_type = models.ManyToManyField("interview.JobType", related_name="qsn_job_types", blank=True)
...
class UserQuestion(models.Model):
    ...
    job_type = models.ManyToManyField("interview.JobType", related_name="user_qsn_job_types", blank=True)
    skill = models.JSONField(null=True, blank=True)
    text = models.CharField(max_length=1024)
    answer_guidelines = models.CharField(max_length=500, null=True, blank=True)
